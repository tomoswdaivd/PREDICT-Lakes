"""Run the paired weekly full anomaly-persistence hindcast."""
...
from predict_lakes.anomaly_persistence_hindcast import run_paired_hindcast, write_paired_hindcast_outputs
...
def main() -> None:
    ...
    write_paired_hindcast_outputs(*result, args.output_dir)
    print(f"wrote paired hindcast outputs to {args.output_dir}")
