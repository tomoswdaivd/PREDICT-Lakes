"""CLI entry point for the expanding prior-year window climatology."""
...
from predict_lakes.climatology import forecast_climatology, write_climatology_forecast
...
def main() -> None:
    ...
    write_climatology_forecast(result, args.output)
